"""
PyQt5 Generator - Code generator for PyQt5 framework
"""
...
class PyQt5Generator(BaseGenerator):
    """Code generator for PyQt5 framework."""
    
    def __init__(self):
        super().__init__("PyQt5")
        ...
        # Widget type mappings (same as PyQt6)
    ...
    def generate_imports(self, project_data: Dict[str, Any]) -> str:
        """Generate PyQt5 import statements."""
        ...
        # Additional imports (note Qt5 vs Qt6 difference)
        imports.extend([
    ...
    def generate_main_file(self, project_data: Dict[str, Any]) -> str:
        """Generate the main PyQt5 application file."""
...
{main_function}"""
    ...
    def generate_widget_code(self, widget_data: Dict[str, Any], parent_var: str = "self") -> str:
        """Generate code for a single PyQt5 widget."""
    ...
    def generate_widget_specific_code(self, widget_type: str, widget_data: Dict[str, Any], var_ref: str) -> str:
        ...
        if widget_type == "Entry":
            ...
            if properties.get("readonly", False):
                code_parts.append(f'{var_ref}.setReadOnly(True)')
            # Note: PyQt5 uses different word wrap API
            if not properties.get("word_wrap", True):
                code_parts.append(f'{var_ref}.setWordWrapMode(QTextOption.NoWrap)')
            ...
            # PyQt5 uses different enum syntax
    ...
    def generate_layout_code(self, container_data: Dict[str, Any], child_widgets: List[Dict[str, Any]]) -> str:
        """Generate layout management code for PyQt5."""
        # Same as PyQt6
    ...
    def generate_button_handler(self, button_name: str, action: Dict[str, Any]) -> str:
        ...
        if action_type == "message":
            ...
            code.append(f'        from PyQt5.QtWidgets import QMessageBox')
